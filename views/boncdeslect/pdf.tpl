	...
	<body>
		<table style="width:100%">
			<tbody>
				...
				<tr>
					<td style="width:100%;height:18px" class="titre" colspan="3"> <strong>BON DE COMMANDE N° &nbsp;{$element.numcde}</strong> </td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="bt bb bl br"  colspan="2" >
						<em>Livré &agrave; : &nbsp;</em>{if $element.lieliv=="P"}Domicile{/if}{if $element.lieliv=="S"}HAD{/if}{if $element.lieliv=="A"}{$element.lielivaut}{/if}<br/><br/>
						<em>Date Livraison :</em>{$element.datliv} - {if $element.jrsliv=="PM"}Apres-midi{/if}{if $element.jrsliv=="AM"}Matin{/if}<br/><br/>
						<em>Commentaire :&nbsp;</em>{$element.com}<br/><br/>
						{if $element.formidel=='O'}
						IDE Formation :<br>
						&nbsp;&nbsp;&nbsp;Contact . :{$element.coordidel}
						&nbsp;&nbsp;&nbsp;Téléphone :{$element.telidel}
						{/if}
					</td>
				</tr>
			</tbody>
			...
			<tbody>
				<tr>
					<td style="width:100%" colspan="4" class="bb bl br bgg">
						<strong>Produit(s) commandé(s) pour le {$element.datliv }</strong>
					</td>
				</tr>
				<tr>
				...
				{foreach $groupes as $k => $groupe}
					<tr>
						<td style="width:100%" colspan="4" class="bb bl br bgg">
							<strong>{$groupe.lb_hierachie} </strong><br />
						</td>
					</tr>
